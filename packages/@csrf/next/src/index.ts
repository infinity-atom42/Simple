...
import type { ConfigOptions } from '@csrf/core/config'
import { Config, TokenOptions } from '@csrf/core/config'
import { createCsrfProtect as _createCsrfProtect, CsrfError } from '@csrf/core/protect'

import { CsrfProvider } from './provider'

export { CsrfError, CsrfProvider }
...
export class NextConfig extends Config {
	override excludePathPrefixes: string[] = ['/_next/']

	override token: NextTokenOptions = new NextTokenOptions()
